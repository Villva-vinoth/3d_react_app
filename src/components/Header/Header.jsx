    ...
    <div className='Header-display'>
      ...
      <div className='Header-inner'>
        ...
        <div className={`header-div others-div-header `} id='Other' >Others
          <div className={`drop-down`}>
            ...
            {blog[0]?.showcase_value == 1 ? <div className={`drop-down-div ${window.location.pathname === '/blogs' ? `drop-select-div` : `header-hide-div`}`} id='Blog' onClick={() => { nav('/blogs') }}>Blogs</div>
              : ('')}
            {testimonial[0]?.showcase_value == 1 ? <div className={`drop-down-div ${window.location.pathname === '/testimonials' ? `drop-select-div` : `header-hide-div`}`} id='Testimonial' onClick={() => { nav('/testimonials') }}>Testimonials</div>
              : ('')}          
              </div>
        </div>
      ...
      <div className='hambarger'>
        ...
        <div className={zero ? 'header-hamberger' : "header-hamberger-hide"}>
          ...
          {blog[0]?.showcase_value == 1 ? <div className={`header-div ${window.location.pathname === '/blogs' ? `header-select-div` : `header-hide-div`}`} id='Blog' onClick={() => { handleHambarger(); nav('/blogs') }}>Blogs</div>
            : ('')}
          {testimonial[0]?.showcase_value == 1 ? <div className={`header-div ${window.location.pathname === '/testimonials' ? `header-select-div` : `header-hide-div`}`} id='Testimonial' onClick={() => { handleHambarger(); nav('/testimonials') }}>Testimonials</div>
            : ('')}         
             {/* </div> */}
          {/* </div> */}
